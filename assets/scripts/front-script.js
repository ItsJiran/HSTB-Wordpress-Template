...
$(document).ready(function(){
    ...
    // +---------------+ HERO CAROUSEL +--------------+
    $(".section-1__carousel").owlCarousel({
        loop:true,
        margin:50,
        responsive:{
            0:{
    ...
    // +---------------+ HERO CAROUSEL +--------------+
    $(".section-3__carousel").owlCarousel({
        loop:true,
        center:true,
        nav:false,
        dots:false,
...
let hero_post_thumbnails = document.getElementsByClassName('hero-2__content-wrapper')[0].children;
...
let questions_container = document.getElementsByClassName('faq-question__container');
